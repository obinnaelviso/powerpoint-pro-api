        ...
        <div class="card shadow-lg">
            <div class="card-body">
                ...
                <p>For a better experience, while using our Service, I may require you to provide us with certain
                    ...
                    and
                    is not collected by me in any way.</p>
                ...
                <ul>
                    <li>
                        ...
                        <h6><strong>Log Data</strong></h6>
                        <p>I want to inform you that whenever you use my Service, in a case of an error in the app I
                            collect data
                            and information (through third-party products) on your phone called Log Data. This Log Data
                            may include
                            information such as your device Internet Protocol (“IP”) address, device name, operating
                            system version,
                            the configuration of the app when utilizing my Service, the time and date of your use of the
                            Service,
                        ...
                        <p></p>I want to inform users of this Service that these third parties have access to their
                        Personal
                    ...
                    <p>I value your trust in providing us your Personal Information, thus we are striving to use
                        ...
                        internet, or
                        method of electronic storage is 100% secure and reliable, and I cannot guarantee its absolute
                        security.</p>
                    <li>
                    ...
                    <li>
                        ...
                        <p>These Services do not address anyone under the age of 13. I do not knowingly collect
                            ...
                            child
                            under
                            13 has provided me with personal information, I immediately delete this from our servers. If
                            you are
                            a
                            parent or guardian and you are aware that your child has provided us with personal
                            information,
                            please
                            contact me so that I will be able to do the necessary actions.</p>
                    </li>
                </ul>
